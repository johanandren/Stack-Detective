...
public final class Distance<T> implements Comparable<Distance> {
	...
	public Distance(T from, T to, double distance) {
		this.from = from;
		this.to = to;
	...
	public int compareTo(Distance o) {
		...
		// TODO this is invalid and causes not-the-same-instances to be treated
		// as the same

		double distanceDiff = distance - o.getDistance();
		if (distanceDiff > 0) {
			return 1;
